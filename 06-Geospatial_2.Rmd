...
*The second part of the fourth assignment again had students using* [LAGOS lake data](https://lagoslakes.org/) *and mapping water quality variables for spatial analysis.* 
...
```{r secchi v chlor, warning=F,message=F}
