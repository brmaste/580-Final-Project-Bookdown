...
*The fourth assignment was in two parts, with the first part using* [LAGOS lake data](https://lagoslakes.org/) *and mapping water quality variables for spatial analysis.* 
...
```{r iowa lakes minn, warning=F,message=F}
